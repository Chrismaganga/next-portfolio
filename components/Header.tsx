      ...
      >
        ...
        <div className="flex items-center justify-between gap-x-4"> 
          <div className="flex items-center gap-x-4">
            ...
            <Button onClick={handleLogout} className="bg-white px-4 py-2 rounded-md">
              Logout
            </Button>
            <Button
              onClick={() => router.push("/account")}
              className="bg-white hover:bg-blue-800 rounded-md"
            >
              <FaUserAlt />
            </Button>
          </div>
          ...
          <>
            <div>
              <Button className="bg-orange-800 px-4 m-1
       py-2 rounded-md">
                Sign up
              </Button>
            </div>
